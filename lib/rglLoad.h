...
typedef void (*glUniform1fPROC)(GLint location, GLint v0);
typedef void (*glUniform2fPROC)(GLint location, GLint v0, GLfloat v1);
typedef void (*glUniform3fPROC)(GLint location, GLint v0, GLfloat v1, GLfloat v2);
typedef void (*glUniform4fPROC)(GLint location, GLint v0, GLfloat v1, GLfloat v2, GLfloat v3);
...
glUniformMatrix2fvPROC glUniformMatrix2fvSRC = NULL;
glUniformMatrix3fvPROC glUniformMatrix3fvSRC = NULL;
...
#define glUniformMatrix2fv glUniformMatrix2fvSRC
#define glUniformMatrix3fv glUniformMatrix3fvSRC
...
int RGL_loadGL3(RGLloadfunc proc) {
    ...
    if (
        ...
        glUniformMatrix2fvSRC == NULL ||
        glUniformMatrix3fvSRC == NULL ||
